^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package temoto_action_assistant
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* [sys] Qt adjustment. 
  ...
  * auto-select Qt version matching the one from rviz `#114 <https://github.com/ros-planning/temoto_action_assistant/issues/114>`_
...
* [sys][travis] Update CI conf for ROS Jade (and optionally added Kinetic) `#116 <https://github.com/ros-planning/temoto_action_assistant/issues/116>`_
...
* Fix for issue `#70 <https://github.com/ros-planning/temoto_action_assistant/issues/70>`_: support yaml-cpp 0.5+ (new api).
...
* Fix `#42 <https://github.com/ros-planning/temoto_action_assistant/issues/42>` plus cosmetic param name change.
...
0.5.5 (2013-12-03)
------------------
* fix `#64 <https://github.com/ros-planning/temoto_action_assistant/issues/64>`_.
...
0.5.2 (2013-08-16)
------------------
* fix `#50 <https://github.com/ros-planning/temoto_action_assistant/issues/50>`_
* fix `#52 <https://github.com/ros-planning/temoto_action_assistant/issues/52>`_
...
* fix `#49 <https://github.com/ros-planning/temoto_action_assistant/issues/49>`_

0.4.1 (2013-06-26)
------------------
* fix `#44 <https://github.com/ros-planning/temoto_action_assistant/issues/44>`_
* detect when xacro needs to be run and generate planning_context.launch accordingly
* fix `#46 <https://github.com/ros-planning/temoto_action_assistant/issues/46>`_
* refactor how planners are added to ompl_planning.yaml; include PRM & PRMstar, remove LazyRRT
* change defaults per `#47 <https://github.com/ros-planning/temoto_action_assistant/issues/47>`_
...
* fix `#41 <https://github.com/ros-planning/temoto_action_assistant/issues/41>`_
