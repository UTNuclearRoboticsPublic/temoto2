...
/* 
 * ACTION IMPLEMENTATION of TaSecondTest 
 */
class TaSecondTest : public temoto_nlp::BaseTask
{
public:
...
TaSecondTest()
{
  ...
  TEMOTO_INFO("TaSecondTest constructed");
}
...
~TaSecondTest()
{
  TEMOTO_INFO("TaSecondTest destructed");
}
...
void startInterface_0()
{
  ...
  TEMOTO_INFO("Second test REPORTING");
...
CLASS_LOADER_REGISTER_CLASS(TaSecondTest, temoto_nlp::BaseTask);
