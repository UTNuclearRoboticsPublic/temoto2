...
{
template <>
struct convert<temoto_sensor_manager::SensorInfo>
{
  static Node encode(const temoto_sensor_manager::SensorInfo& sensor)
  {
    Node node;
  ...
  static bool decode(const Node& node, temoto_sensor_manager::SensorInfo& sensor)
  {
