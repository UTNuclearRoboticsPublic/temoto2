...
bool SensorInfoRegistry::findLocalSensors( temoto_sensor_manager::LoadSensor::Request& req
...
bool SensorInfoRegistry::findRemoteSensors( temoto_sensor_manager::LoadSensor::Request& req
                                          , std::vector<SensorInfo>& si_ret ) const
{
  // Lock the mutex
  std::lock_guard<std::mutex> guard(read_write_mutex);
...
bool SensorInfoRegistry::findSensors( temoto_sensor_manager::LoadSensor::Request& req
