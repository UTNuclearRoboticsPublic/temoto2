...
// First implementaton
class StringAccepter: public TTP::BaseTask
{
public:
...
// -------------------------------< USER CODE >-------------------------------
  ...
  TEMOTO_INFO_STREAM("The data I received: " << what_0_data_0_in);
...
CLASS_LOADER_REGISTER_CLASS(StringAccepter, TTP::BaseTask);
