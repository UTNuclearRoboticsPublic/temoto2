...
private:
     ...
     * @return
     */
    void loadGestureCb (temoto_2::LoadGesture::Request& req,
    ...
    void unloadGestureCb (temoto_2::LoadGesture::Request& req,
                          temoto_2::LoadGesture::Response& res);
    /**
     ...
     * @return
     */
    void unloadSpeechCb (temoto_2::LoadSpeech::Request& req,
                         temoto_2::LoadSpeech::Response& res);
