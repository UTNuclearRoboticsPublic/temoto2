...
public:
  ...
  bool call(ServiceType& msg)
  {
    ...
    if (q_it == queries_.end())
    {
      ...
      {
        throw CREATE_ERROR(error::Code::SERVICE_REQ_FAIL, "Service call to %s returned false.",
  ...
  void sendUnloadRequest(temoto_id::ID ext_resource_id)
  {
    ...
    {
      throw CREATE_ERROR(error::Code::SERVICE_REQ_FAIL, "Call to %s failed.", service_client_unload_.getService().c_str());
    }
  }
  ...
  getInternalResources(temoto_id::ID ext_resource_id)
  {
    ...
    {
      throw CREATE_ERROR(error::Code::RMP_NOT_FOUND, "Resource_id '%ld' was not found!",
                         ext_resource_id);
    }
