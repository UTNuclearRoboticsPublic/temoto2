...
/* 
 * ACTION IMPLEMENTATION of TaFindRosDevices 
 */
class TaFindRosDevices : public TTP::BaseTask
{
public:
...
TaFindRosDevices()
{
  ...
  TEMOTO_INFO("TaFindRosDevices constructed");
}
...
~TaFindRosDevices()
{
  TEMOTO_INFO("TaFindRosDevices destructed");
}
...
void startInterface_0()
{
  ...
  while(!stop_task_)
  {
    TEMOTO_INFO("sniff, sniff ...");
    ros::Duration(1).sleep();
  }
}

}; // TaFindRosDevices class

/* REQUIRED BY CLASS LOADER */
CLASS_LOADER_REGISTER_CLASS(TaFindRosDevices, TTP::BaseTask);
